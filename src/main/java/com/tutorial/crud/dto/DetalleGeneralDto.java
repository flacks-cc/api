...
public class DetalleGeneralDto {
    ...
    public DetalleGeneralDto() {
        // deja este constructor vacío o inicializa tus campos si es necesario
    }

    // Constructor con Usuario y Servicio
    public DetalleGeneralDto(int cantidad, double total, Producto producto, Usuario usuario, Reservacion reservacion) {
	...
	public DetalleGeneralDto(int cantidad, double total, Reservacion reservacion,  Producto producto, Usuario usuario ) {
	    this.cantidad = cantidad;
	    this.total = total;
	    this.reservacion = reservacion;
	    this.producto = producto;
