...
public class Resena {
	...
	// Constructor lleno
	public Resena(String mensaje, int valoracion, LocalDateTime fechaHora, Usuario cliente, Producto producto,
			Servicio servicio) {
	...
	public String toString() {
		return "Resena [idResena=" + idResena + ", mensaje=" + mensaje + ", valoracion=" + valoracion + ", fechaHora="
				+ fechaHora + ", cliente=" + cliente + ", producto=" + producto + ", servicio=" + servicio + "]";
	}
}
