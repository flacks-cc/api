...
public interface ReservaRepository extends JpaRepository<Reserva, Long> {
 ...
 // Define el método para buscar reservaciones en un intervalo de tiempo
    List<Reserva> findByHoraInicioBetweenOrHoraFinBetween(
    		LocalTime start1, LocalTime end1, LocalTime start2, LocalTime end2);
    
    List<Reserva> findByHoraInicioBetweenAndFechaOrHoraFinBetweenAndFecha(
    	    LocalTime horaInicio1, LocalTime horaFin1, LocalDate fecha1,
    	    LocalTime horaInicio2, LocalTime horaFin2, LocalDate fecha2);
}
